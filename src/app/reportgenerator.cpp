...
ReportGenerator * gpReportGenerator = nullptr;

//=========================================================================

void ReportGenerator::WriteMagesCSV()
{
    std::string FName;
    std::string S;
...
void ReportGenerator::CheckTaxDetails  (CLand  * pLand, CTaxProdDetailsCollByFaction & TaxDetails)
{
    int               x;
    CUnit           * pUnit;
...
void ReportGenerator::CheckTradeDetails(CLand  * pLand, CTaxProdDetailsCollByFaction & TradeDetails)
{
    int             x, k;
    CUnit         * pUnit;
    EValueType      type;
...
void ReportGenerator::CheckTaxTrade()
{
    std::string sTax;
    std::string sTrade;
    std::string Report, S;
...
void ReportGenerator::CheckProduction()
{
    int    n, i, x;
    CLand  * pLand;
    CPlane * pPlane;
...
void ReportGenerator::CheckSailing()
{
    int    n, i, x;
    CLand  * pLand;
    CPlane * pPlane;
...
void ReportGenerator::ShowDescriptionList(CBaseColl & Items, const char * title) // Collection of CBaseObject
{
    CBaseObject  * pObj;
...
void ReportGenerator::ShowDescriptionList(CBaseCollById & Items, const char * title)
{
...
void ReportGenerator::ViewShortNamedObjects(bool ViewAll, const char * szSection, const char * szHeader, CBaseColl & ListNew)
{
    CBaseColl     Items;
    CBaseObject * pItem;
    const char  * szName;
...
void ReportGenerator::ViewEvents(bool DoEvents)
{
    CBaseColl   Coll;
...
void ReportGenerator::ViewSecurityEvents()
{
/*    CBaseColl   Coll;
...
void ReportGenerator::ViewNewProducts()
{
...
void ReportGenerator::ViewBattlesAll()
{
...
void ReportGenerator::ViewGates()
{
...
void ReportGenerator::ViewCities()
{
...
void ReportGenerator::ViewProvinces()
{
    CBaseCollByName    coll;
    int                np,nl;
    CPlane           * pPlane;
...
void ReportGenerator::ViewFactionInfo()
{
...
void ReportGenerator::ViewFactionOverview_IncrementValue(long FactionId, const char * factionname, CBaseCollById & Factions, const char * propname, long value)
{
...
void ReportGenerator::ViewFactionOverview()
{
//m_UnitPropertyNames
...
void ReportGenerator::CheckMonthLongOrders()
{
...
void ReportGenerator::ShowUnitsMovingIntoHex(long CurHexId, CPlane * pCurPlane)
{
    CLand          * pLand;
    CUnit          * pUnit;
    int              nl, nu, i;
...
bool ReportGenerator::GetExportHexOptions(std::string & FName, std::string & FMode, SAVE_HEX_OPTIONS & options, eHexIncl & HexIncl,
                                 bool & InclTurnNoAcl )
{
...
void ReportGenerator::ExportOneHex(CFileWriter & Dest, CPlane * pPlane, CLand * pLand, SAVE_HEX_OPTIONS & options, bool InclTurnNoAcl, bool OnlyNew)
{
...
void ReportGenerator::ExportHexes()
{
    std::string               sData, sName;
    CMapPane         * pMapPane  = (CMapPane* )gpUIController->m_Panes[AH_PANE_MAP];
...
void ReportGenerator::FindTradeRoutes()
{
    CMapPane    * pMapPane  = (CMapPane* )gpUIController->m_Panes[AH_PANE_MAP];
    CBaseColl     Hexes(64);
...
void ReportGenerator::ViewMovedUnits()
{
}
